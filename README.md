...
Matches a route the same way the Route component does, allowing a variable in place of a URL.
1. How would you explain form validation to someone who has never programmed before?
Ensuring correct data; consistency; less bugs, etc
1. In 1-2 sentences, define end to end testing.
A wholly tested application, beginning to end, tested thoroughly to ensure every single part of every action possible works correctly.
